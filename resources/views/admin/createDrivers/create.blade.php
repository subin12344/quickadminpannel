...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.createDriver.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.create-drivers.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="licence_no">{{ trans('cruds.createDriver.fields.licence_no') }}</label>
                <input class="form-control {{ $errors->has('licence_no') ? 'is-invalid' : '' }}" type="text" name="licence_no" id="licence_no" value="{{ old('licence_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expirydate') ? 'is-invalid' : '' }}" type="text" name="expirydate" id="expirydate" value="{{ old('expirydate') }}">
