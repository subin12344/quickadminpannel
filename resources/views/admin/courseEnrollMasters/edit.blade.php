    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.course-enroll-masters.update", [$courseEnrollMaster->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status_at') ? 'is-invalid' : '' }}" type="number" name="status_at" id="status_at" value="{{ old('status_at', $courseEnrollMaster->status_at) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('enroll_number') ? 'is-invalid' : '' }}" type="text" name="enroll_number" id="enroll_number" value="{{ old('enroll_number', $courseEnrollMaster->enroll_number) }}" required>
